...
export const Description = (props) => {
  console.log('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',props.data1);
  return (
    <div class="property-page">
    <div className='propTitle'>
    <div class = "banner1">
    <p><h3> {props.data1[0].propTitle}</h3> &nbsp; <h5>3-star</h5></p>
    ...
    <span className = 'price'><b> {props.data1[0].propPrice} CAD</b></span>
    <br /><Link to={`/#`} className="btn-primary btn button">Choose Room </Link>
    </div></div>
    <div class="desc-body">
    <div className='prop'>
    <div class="img-slide"> <img src={props.data1[0].image} alt="" /></div> 
    <table className='amenities'>
    <tr ><td colspan='5'><h3>{props.data1[0].propDescription} </h3></td></tr>
    ...
    <input class="result" type="text" placeholder={props.data1[0].propLocation.streetAddress} readOnly />
    
    <div class="review">
    <span class="rev"> 8.6</span> <b> Fabulous</b> <br/>
